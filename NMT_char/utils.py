...
def pad_sents_char(sents, char_pad_token):
    ...
    sents_padded = [[word + [char_pad_token] * (max_word_length - len(word)) if len(word) < max_word_length else word[:max_word_length] for word in sent] + 
                      [[char_pad_token]*max_word_length] * (max_sent_length - len(sent)) for sent in sents]
#    print(sents_padded)
    ### END YOUR CODE
